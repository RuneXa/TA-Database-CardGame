...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2015 at 03:54 PM
...
--
ALTER TABLE `tb_deck`
 ADD UNIQUE KEY `id_user_2` (`id_user`), ADD KEY `kodekartu` (`kodekartu`), ADD KEY `id_user` (`id_user`);

--
-- Indexes for table `tb_kartu`
--
ALTER TABLE `tb_kartu`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `kode_kartu` (`kode_kartu`), ADD UNIQUE KEY `kode_kartu_2` (`kode_kartu`), ADD KEY `kode_kartu_3` (`kode_kartu`);
...
--
ALTER TABLE `tb_deck`
ADD CONSTRAINT `tb_deck_ibfk_1` FOREIGN KEY (`kodekartu`) REFERENCES `tb_kartu` (`kode_kartu`),
...
--
ALTER TABLE `tb_winrate`
ADD CONSTRAINT `tb_winrate_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `tb_user` (`id_user`);
